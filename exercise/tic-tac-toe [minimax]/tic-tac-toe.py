...
class ComputerPlayer(XOPlayer):
    ...
    def hard(self, game):
        _, move = self.max_value(game, game.board)
        return move

    def max_value(self, game, board):
        ...
        for move in valid_moves:
            ...
            score, _ = self.min_value(game, board)
            board[move] = " "
    ...
    def min_value(self, game, board):
        ...
        for move in valid_moves:
            ...
            score, _ = self.max_value(game, board)
            board[move] = " "
